...
export const DEVICE_FLAGS: DeviceFlag[] = [
  { bit: 0x2, name: 'system-level-blocking', title: 'Замораживать закрытые приложения (закрывает и видео в окошке)' },
  ...
  { bit: 0x40, name: 'network-time-system', title: 'Время по сети на уровне системы' },
